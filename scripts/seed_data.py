...
async def seed_grades():
    ...
    await Grade.all().delete()
    await Grade.bulk_create([Grade(**g) for g in grades])
...
async def seed_dungeons():
    ...
    await Dungeon.all().delete()
    await Dungeon.bulk_create([Dungeon(**d) for d in dungeons])
...
async def seed_monsters():
    ...
    await Monster.bulk_create([Monster(**m) for m in monsters])
...
async def seed_skills():
    ...
    await Skill_Model.all().delete()
    await Skill_Model.bulk_create([Skill_Model(**s) for s in skills])
...
async def seed_items():
    ...
    # === 장비 아이템 ===
    equipment_items = [
        {"item": {"id": 1001, "name": "나무 검", "description": "초보자용 나무 검", "cost": 100, "type": ItemType.EQUIP}, "equipment": {"attack": 5, "grade": 1, "equip_pos": 4}},
        {"item": {"id": 1002, "name": "철검", "description": "기본적인 철제 검", "cost": 500, "type": ItemType.EQUIP}, "equipment": {"attack": 12, "grade": 1, "equip_pos": 4}},
        {"item": {"id": 1003, "name": "강철검", "description": "고급 강철로 만든 검", "cost": 1500, "type": ItemType.EQUIP}, "equipment": {"attack": 25, "speed": 3, "grade": 2, "equip_pos": 4}},
        {"item": {"id": 1004, "name": "화염검", "description": "불꽃이 타오르는 검", "cost": 3000, "type": ItemType.EQUIP}, "equipment": {"attack": 35, "grade": 2, "equip_pos": 4}},
        {"item": {"id": 1005, "name": "얼음검", "description": "냉기를 뿜는 검", "cost": 3000, "type": ItemType.EQUIP}, "equipment": {"attack": 35, "grade": 2, "equip_pos": 4}},
        {"item": {"id": 1006, "name": "번개검", "description": "번개가 감도는 검", "cost": 5000, "type": ItemType.EQUIP}, "equipment": {"attack": 50, "speed": 5, "grade": 3, "equip_pos": 4}},
        {"item": {"id": 1007, "name": "용의 검", "description": "드래곤의 비늘로 만든 검", "cost": 15000, "type": ItemType.EQUIP}, "equipment": {"attack": 80, "hp": 100, "grade": 4, "equip_pos": 4}},
        {"item": {"id": 1008, "name": "전설의 검", "description": "전설에 나오는 명검", "cost": 50000, "type": ItemType.EQUIP}, "equipment": {"attack": 120, "speed": 10, "grade": 5, "equip_pos": 4}},
        {"item": {"id": 2001, "name": "천 두건", "description": "가벼운 천으로 만든 두건", "cost": 80, "type": ItemType.EQUIP}, "equipment": {"hp": 20, "grade": 1, "equip_pos": 1}},
        {"item": {"id": 2002, "name": "가죽 모자", "description": "튼튼한 가죽 모자", "cost": 300, "type": ItemType.EQUIP}, "equipment": {"hp": 40, "grade": 1, "equip_pos": 1}},
        {"item": {"id": 2003, "name": "철 투구", "description": "단단한 철제 투구", "cost": 1000, "type": ItemType.EQUIP}, "equipment": {"hp": 80, "grade": 2, "equip_pos": 1}},
        {"item": {"id": 2004, "name": "강철 투구", "description": "고급 강철 투구", "cost": 2500, "type": ItemType.EQUIP}, "equipment": {"hp": 120, "grade": 3, "equip_pos": 1}},
        {"item": {"id": 2005, "name": "용의 투구", "description": "드래곤 비늘로 만든 투구", "cost": 12000, "type": ItemType.EQUIP}, "equipment": {"hp": 200, "attack": 15, "grade": 4, "equip_pos": 1}},
        {"item": {"id": 2101, "name": "천 옷", "description": "기본적인 천 의복", "cost": 100, "type": ItemType.EQUIP}, "equipment": {"hp": 30, "grade": 1, "equip_pos": 2}},
        {"item": {"id": 2102, "name": "가죽 갑옷", "description": "튼튼한 가죽 갑옷", "cost": 500, "type": ItemType.EQUIP}, "equipment": {"hp": 60, "grade": 1, "equip_pos": 2}},
        {"item": {"id": 2103, "name": "사슬 갑옷", "description": "쇠사슬로 엮은 갑옷", "cost": 1500, "type": ItemType.EQUIP}, "equipment": {"hp": 100, "grade": 2, "equip_pos": 2}},
        {"item": {"id": 2104, "name": "판금 갑옷", "description": "철판으로 만든 갑옷", "cost": 4000, "type": ItemType.EQUIP}, "equipment": {"hp": 180, "grade": 3, "equip_pos": 2}},
        {"item": {"id": 2105, "name": "용의 갑옷", "description": "드래곤 비늘 갑옷", "cost": 15000, "type": ItemType.EQUIP}, "equipment": {"hp": 300, "attack": 20, "grade": 4, "equip_pos": 2}},
        {"item": {"id": 2301, "name": "천 신발", "description": "가벼운 천 신발", "cost": 80, "type": ItemType.EQUIP}, "equipment": {"speed": 2, "grade": 1, "equip_pos": 3}},
        {"item": {"id": 2302, "name": "가죽 부츠", "description": "튼튼한 가죽 부츠", "cost": 400, "type": ItemType.EQUIP}, "equipment": {"speed": 4, "grade": 1, "equip_pos": 3}},
        {"item": {"id": 2303, "name": "철 장화", "description": "단단한 철제 장화", "cost": 1200, "type": ItemType.EQUIP}, "equipment": {"speed": 6, "hp": 30, "grade": 2, "equip_pos": 3}},
        {"item": {"id": 2304, "name": "바람의 부츠", "description": "바람을 담은 부츠", "cost": 3500, "type": ItemType.EQUIP}, "equipment": {"speed": 12, "grade": 3, "equip_pos": 3}},
        {"item": {"id": 2305, "name": "용의 부츠", "description": "드래곤 가죽 부츠", "cost": 10000, "type": ItemType.EQUIP}, "equipment": {"speed": 18, "hp": 80, "grade": 4, "equip_pos": 3}},
        {"item": {"id": 4001, "name": "나무 방패", "description": "가벼운 나무 방패", "cost": 150, "type": ItemType.EQUIP}, "equipment": {"hp": 25, "grade": 1, "equip_pos": 5}},
        {"item": {"id": 4002, "name": "철 방패", "description": "튼튼한 철제 방패", "cost": 800, "type": ItemType.EQUIP}, "equipment": {"hp": 50, "grade": 2, "equip_pos": 5}},
        {"item": {"id": 4003, "name": "기사의 방패", "description": "기사단의 방패", "cost": 3000, "type": ItemType.EQUIP}, "equipment": {"hp": 100, "grade": 3, "equip_pos": 5}},
        {"item": {"id": 4004, "name": "용의 방패", "description": "드래곤 비늘 방패", "cost": 12000, "type": ItemType.EQUIP}, "equipment": {"hp": 180, "attack": 15, "grade": 4, "equip_pos": 5}},
    ]

    # Item + EquipmentItem bulk 삽입
    item_objects = [Item(**ed["item"]) for ed in equipment_items]
    await Item.bulk_create(item_objects, on_conflict=["id"], update_fields=["name", "description", "cost", "type"])

    # item FK 연결을 위해 다시 조회
    item_map = {i.id: i for i in await Item.filter(id__in=[ed["item"]["id"] for ed in equipment_items])}
    equip_objects = []
    for ed in equipment_items:
        equip_dict = ed["equipment"].copy()
        equip_dict["item"] = item_map[ed["item"]["id"]]
        equip_objects.append(EquipmentItem(**equip_dict))
    await EquipmentItem.bulk_create(equip_objects, on_conflict=["item_id"], update_fields=["attack", "hp", "speed", "grade", "equip_pos"])
    ...
    consume_item_objects = [Item(**cd["item"]) for cd in consume_items]
    await Item.bulk_create(consume_item_objects, on_conflict=["id"], update_fields=["name", "description", "cost", "type"])

    consume_item_map = {i.id: i for i in await Item.filter(id__in=[cd["item"]["id"] for cd in consume_items])}
    consume_objects = [
        ConsumeItem(item=consume_item_map[cd["item"]["id"]], amount=cd["amount"])
        for cd in consume_items
    ]
    await ConsumeItem.bulk_create(consume_objects, on_conflict=["item_id"], update_fields=["amount"])
...
async def seed_item_grade_probability():
    ...
    await ItemGradeProbability.bulk_create([ItemGradeProbability(**p) for p in grade_probs])
...
async def seed_droptable():
    ...
    await Droptable.bulk_create([Droptable(**d) for d in drops])
...
async def seed_dungeon_spawns():
    ...
    spawns = [
        {"dungeon_id": 1, "monster_id": 1, "prob": 0.40},
        {"dungeon_id": 1, "monster_id": 2, "prob": 0.30},
        {"dungeon_id": 1, "monster_id": 3, "prob": 0.20},
        {"dungeon_id": 1, "monster_id": 101, "prob": 0.10},
        {"dungeon_id": 2, "monster_id": 2, "prob": 0.30},
        {"dungeon_id": 2, "monster_id": 4, "prob": 0.20},
        {"dungeon_id": 2, "monster_id": 5, "prob": 0.20},
        {"dungeon_id": 2, "monster_id": 6, "prob": 0.15},
        {"dungeon_id": 2, "monster_id": 101, "prob": 0.15},
        {"dungeon_id": 3, "monster_id": 10, "prob": 0.30},
        {"dungeon_id": 3, "monster_id": 11, "prob": 0.25},
        {"dungeon_id": 3, "monster_id": 12, "prob": 0.20},
        {"dungeon_id": 3, "monster_id": 13, "prob": 0.15},
        {"dungeon_id": 3, "monster_id": 102, "prob": 0.10},
        {"dungeon_id": 4, "monster_id": 14, "prob": 0.30},
        {"dungeon_id": 4, "monster_id": 15, "prob": 0.25},
        {"dungeon_id": 4, "monster_id": 16, "prob": 0.20},
        {"dungeon_id": 4, "monster_id": 17, "prob": 0.15},
        {"dungeon_id": 4, "monster_id": 103, "prob": 0.10},
        {"dungeon_id": 5, "monster_id": 18, "prob": 0.30},
        {"dungeon_id": 5, "monster_id": 19, "prob": 0.25},
        {"dungeon_id": 5, "monster_id": 20, "prob": 0.20},
        {"dungeon_id": 5, "monster_id": 21, "prob": 0.15},
        {"dungeon_id": 5, "monster_id": 104, "prob": 0.10},
        {"dungeon_id": 6, "monster_id": 22, "prob": 0.30},
        {"dungeon_id": 6, "monster_id": 23, "prob": 0.25},
        {"dungeon_id": 6, "monster_id": 24, "prob": 0.20},
        {"dungeon_id": 6, "monster_id": 25, "prob": 0.15},
        {"dungeon_id": 6, "monster_id": 105, "prob": 0.10},
        {"dungeon_id": 7, "monster_id": 26, "prob": 0.30},
        {"dungeon_id": 7, "monster_id": 27, "prob": 0.25},
        {"dungeon_id": 7, "monster_id": 28, "prob": 0.25},
        {"dungeon_id": 7, "monster_id": 29, "prob": 0.10},
        {"dungeon_id": 7, "monster_id": 106, "prob": 0.10},
        {"dungeon_id": 8, "monster_id": 30, "prob": 0.30},
        {"dungeon_id": 8, "monster_id": 31, "prob": 0.25},
        {"dungeon_id": 8, "monster_id": 32, "prob": 0.20},
        {"dungeon_id": 8, "monster_id": 33, "prob": 0.15},
        {"dungeon_id": 8, "monster_id": 107, "prob": 0.10},
        {"dungeon_id": 9, "monster_id": 34, "prob": 0.30},
        {"dungeon_id": 9, "monster_id": 35, "prob": 0.25},
        {"dungeon_id": 9, "monster_id": 36, "prob": 0.20},
        {"dungeon_id": 9, "monster_id": 37, "prob": 0.15},
        {"dungeon_id": 9, "monster_id": 108, "prob": 0.10},
        {"dungeon_id": 10, "monster_id": 38, "prob": 0.30},
        {"dungeon_id": 10, "monster_id": 39, "prob": 0.25},
        {"dungeon_id": 10, "monster_id": 40, "prob": 0.25},
        {"dungeon_id": 10, "monster_id": 41, "prob": 0.20},
    ]

    await DungeonSpawn.all().delete()
    await DungeonSpawn.bulk_create([DungeonSpawn(**s) for s in spawns])
