...
### 6.4 키워드 밀도 시너지 시스템
- [x] 속성 키워드 밀도 시너지 (3/5/7/10개)
- [x] 효과 키워드 밀도 시너지 (3/5개)
- [x] 마스터리 시너지 (10개 단일 속성 키워드)
- [x] 키워드 조합 시너지 (원소 조화, 빛과 어둠, 글래스 캐논, 철벽 방어, 버서커, 서바이버, 상태이상 마스터, 셋업-피니셔 특화, 궁극기 특화)
- [x] 시너지 스택 규칙 (마스터리 배타, 다종 중첩 허용)
